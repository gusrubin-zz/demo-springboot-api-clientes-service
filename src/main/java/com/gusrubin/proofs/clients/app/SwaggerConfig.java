...
* Swagger UI: http://{server.host}:{server.port}/{server.contextPath}/swagger-ui.html
* Swagger API-Docs: http://{server.host}:{server.port}/{server.contextPath}/v2/api-docs?group=api-epay-ecommerce
* @version 1.0
